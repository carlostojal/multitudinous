...
class ViLBERT_Encoder(nn.Module):
    ...
    def __init__(self, embedding_dim: int = 768, num_heads: int = 16, masking_prob: float = 0.15, mask_prob: float = 0.8, random_prob: float = 0.1, unchanged_prob: float = 0.1) -> None:
        super().__init__()
...
class ViLBERT(nn.Module):
    ...
    def __init__(self, embedding_dim: int = 768, num_heads: int = 16, num_layers: int = 6, coatt_every: int = 2) -> None:
        super().__init__()
